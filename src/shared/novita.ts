...
export const NOVITA: Novita[] = [
  {
    ...
    righe: [
      ...
      '**Riprendere un autopilota finito riparte davvero.** Prima, con le chat tutte «finite», «Riprendi» lo rimetteva «al lavoro» senza far ripartire nessuna chat.',
      '**«Mandaglielo» non fallisce più dopo tre secondi.** La chiamata al servizio per tradurre una frase in un cambio aveva lo stesso tetto di tre secondi delle altre, mentre il supervisore ci mette minuti: la scheda diceva «il servizio autopilota non risponde» e intanto il cambio veniva applicato lo stesso.',
      '**La pagina del telefono si ridisegna anche a computer fermo.** Toccare un autopilota, aprire le cartelle, la coda, il Drive o le impostazioni cambiava la pagina solo quando una chat stava scrivendo (era lei a far ridisegnare tutto): a PC fermo il dettaglio non compariva e il Drive restava su «Leggo il Drive…». Ora ogni cosa letta apposta entra nell’impronta della pagina.'
    ]
  },
  {
    versione: '0.26.0',
